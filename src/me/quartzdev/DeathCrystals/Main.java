...
public class Main extends JavaPlugin {
	...
	public void onEnable() {
		...
		inventoryInteractListener = new InventoryInteractListener(this, storage, config);
		...
		this.getServer().getPluginManager().registerEvents(inventoryInteractListener, this);
	}
